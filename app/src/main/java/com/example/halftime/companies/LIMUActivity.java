...
public class LIMUActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22liberty%20mutual%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("Tell me about a time when you had to solve a problem from somebody else's perspective.");
        questions.add("Tell me about a time when you had to lead a new initiative.");
        questions.add("Tell me about a time when you've made a mistake and had to own up to it.");
        questions.add("Tell me about a time when you had to lead a project with multiple stakeholders.");
        questions.add("What outlook do you have for your former employer's business for the next 1-2 years?");
        questions.add("Tell me about a time you had to get buy in from management, influence others.");
        questions.add("Tell me about a time you understood a problem from someone else's perspective.");
        questions.add("Tell me about a time you had to do something outside of your job description.");
        questions.add("Tell me about your communication style.");

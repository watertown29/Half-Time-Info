...
public class FidelityActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22fidelity%20investments%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("If two companies's EPS and growth profile for the next 2-3 years are similar, what are the possible reasons for different trading PE?");
        questions.add("Stock pitch questions: What is this company's free cash flow yield? What does that yield look like throughout the forecasted years in your model?");
        questions.add("Stock pitch question: What were the earnings like for this company during the '08-'09 recession?");
        questions.add("If you can only choose one financial statement, which one would you choose?");
        questions.add("Pitch me a stock (ended up pitching three stocks in total for the first round).");
        questions.add("What is the breakout for COGS and what are the main drivers for this expense (related to my pitch).");

...
public class DanoneActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22Danone%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("If you were going to launch a plant based cheese what would you do?");
        questions.add("You are the brand manager on a new type of organic spinach. What steps would you take on your first day?");
        questions.add("Your profits are down but sales are up. What is going on?");
        questions.add("What is an ad campaign you like?");
        questions.add("What is an ad campaign that you think missed the mark?");
        questions.add("Why do you want to switch your career into brand management?");
        questions.add("How do you prioritize projects?");
        questions.add("Tell me about a time you used data to solve a problem at work.");
        questions.add("Walmart is planning to introduce its own brand to directly compete with our Greek yogurt. How do you respond?");

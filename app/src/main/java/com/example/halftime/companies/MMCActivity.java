...
public class MMCActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22marsh%20mclennan%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("Tell me about a piece of positive feedback you received.");
        questions.add("What was your least favorite class in undergrad and how did you deal with that?");
        questions.add("What’s our stock price? ");
        questions.add("Where can we grow? ");
        questions.add("Which multiples do you like the best?");
        questions.add("Be prepared for rapid fire questions. They want you to know a lot about their business and how they make money.");
        questions.add("Which business is more cyclical - insurance or consulting?");
        questions.add("What's the definition of an optimal capital structure?");
        questions.add("f MMC was considering acquiring a firm and WACC went up, would this increase or decrease the IRR of the potential acquisition?");

...
public class PepsiActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22Pepsi%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("What is your favorite PepsiCo product?");
        questions.add("Why PepsiCo?");
        questions.add("What is an ad campaign you liked?");
        questions.add("What is a time you analyzed data");
        questions.add("What is another time you analyzed data?");
        questions.add("Why consumer packaged goods?");
        questions.add("Are you more interested in food or beverage?");
        questions.add("What would you do to gain market share from PepsiCo?");

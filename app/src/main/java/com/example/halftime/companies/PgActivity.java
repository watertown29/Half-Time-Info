...
public class PgActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22Proctor%20Gamble%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("Let's say you are given 4 different projects to manage at the same time, how would you approach this?");
        questions.add("Why do you want to work for P&G?");
        questions.add("What are you looking forward to about life in Cincinnati?");
        questions.add("Tell me about a time you or others leveraged your expertise?");
        questions.add("Tell me about a creative solution you created.");
        questions.add("Why consumer packaged goods?");
        questions.add("What's your management style and give me an example.");
        questions.add("Tell me about a time when you faced an ethical dilemma.");
        questions.add("What is your favorite Proctor & Gamble product?");

...
public class ABInbevActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22AB%Inbev%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("Why AB InBev?");
        questions.add("Tell me about a brand, outside of ABInbev, that you think does a great job.");
        questions.add("How would you describe your former company's culture? What did you like/dislike? What was the culture like after the acquisition?");
        questions.add("Tell me about how one of our brands is positioned and why that does/doesn't work");
        questions.add("If ABI were to get into a new product category, what should it be and why?");
        questions.add("If you won all the money in the world, what would you do?");
        questions.add("In a negotiation, how do you remove the strength of the supplier?");
        questions.add("What do you think the next big opportunity is for the beer industry, and how can AB InBev best position itself to succeed?");
        questions.add("As a global company, you may be required to take positions in areas like Belgium or Brazil in order to move up. Is that a problem?");

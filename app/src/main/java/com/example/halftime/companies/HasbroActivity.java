...
public class HasbroActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22Hasbro%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("What unique qualities do you bring to Hasbro?");
        questions.add("What is one marketing campaign that you are impressed with?");
        questions.add("Why Hasbro");
        questions.add("Why do you want to work in toys?");
        questions.add("What parts of being a brand manager excites you?");
        questions.add("Why do you want to live in Rhode Island");
        questions.add("Why do you want to work in entertainment");
        questions.add("Tell me about a time you used data to drive business.");
        questions.add("Why is the toy industry right for you?");

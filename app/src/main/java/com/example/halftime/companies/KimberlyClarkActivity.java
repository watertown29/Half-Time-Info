...
public class KimberlyClarkActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22Kimberly%20Clark%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("Why are you interested in Kimberly Clark?");
        questions.add("What is your favorite Kimberly-Clark brand and why?");
        questions.add("What do you expect to learn while working here?");
        questions.add("Where do you see yourself in five years from now?");
        questions.add("Can you walk me through your résumé?");
        questions.add("What is a marketing trend you have noticed?");
        questions.add("How do you stay current with marketing trends?");

...
public class CocaColaActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22Coca-Cola%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("Tell me about a time when you used marketing concepts to solve a business problem.");
        questions.add("Tell me about a time when you took a risk and it didn't pay off.");
        questions.add("Why brand marketing? ");
        questions.add("Why Coca-Cola?");
        questions.add("Tell me about a time when you used marketing concepts to solve a business problem.");
        questions.add("Tell me about a time when you took a risk and it didn't pay off.");
        questions.add("Tell me about a time when you used quantitative data to solve a problem");
        questions.add("What is a product you think is marketed well? How so?");
        questions.add("What is a product you think is marketed poorly? How so?");

...
public class EJGalloActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22Gallo%20winery%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("Why do you want to work on the business side of wine and spirits?");
        questions.add("Why Gallo?");
        questions.add("What is your connection to California/have you visited?");
        questions.add("What is a product that you like?");
        questions.add("If you were to work for Gallo, which brand would you want to be on and why?");
        questions.add("What type of product innovation would you implement for the brand you previously mentioned? What consumer need does it fill?");
        questions.add("What is your favorite non-Gallo campaign?");
        questions.add("Tell me about a time that you demonstrated leadership and what challenges occurred.");
        questions.add("Tell me about a time you had to influence people.");

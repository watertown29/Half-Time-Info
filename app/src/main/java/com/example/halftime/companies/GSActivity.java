...
public class GSActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22goldman%20sachs%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("What would be your biggest difficulty coming here to work?");
        questions.add("Why are you interested in this group?");
        questions.add("What do you bring to the table that others do not?");
        questions.add("Estimate how many gas stations are in the US How do you analyze a company?");
        questions.add("Why do you want to work for Goldman?");
        questions.add("What's your view on the equity markets in the next 12 months?");
        questions.add("What would you say to a client who is calling upset about the recent market drop?");
        questions.add("Why does china matter to the S&P 500 from an analytical perspective?");
        questions.add("What is oil outlook from an analytical perspective and how would you calculate the bottom? ");

...
public class PayPalActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22paypal%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("What transferable skills do you have that align with the job description?");
        questions.add("What are you looking for in a PM role?");
        questions.add("Why Paypal?");
        questions.add("What is the difference between Product Manager, Project Manager and Program Manager?");
        questions.add("Tell me a time you had to show initiative?");
        questions.add("What do you know about Blockchain?");

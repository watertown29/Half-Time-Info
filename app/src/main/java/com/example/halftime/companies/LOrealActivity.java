...
public class LOrealActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22L'Oreal%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("Why cosmetics?");
        questions.add("Tell me about a recent beauty product launch that was successful.");
        questions.add("Based on your digital experience and interest, in your opinion, what would you say is the next new ‘social media ‘ platform?");
        questions.add("What was your honest initial impression of the company and has it changed?");
        questions.add("Why L'Oreal?");
        questions.add("Tell me about a time you had a conflict with an employee.");
        questions.add("Tell me about a time you were put in a difficult situation.");
        questions.add("Are you more interested in consumer goods or luxury goods?");
        questions.add("Give me an example of a good product launch this year.");

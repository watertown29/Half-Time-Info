...
public class CitiActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22Citi%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("How did you choose your prior industry?");
        questions.add("What are three major sources revenue for People's magazine?");
        questions.add("What questions do you have for me about our group?");
        questions.add("Who is your favorite financial reporter and why?");
        questions.add("What gaps (in skills) do you see in your professional and academic background?");
        questions.add("What do you bring to Citi?");
        questions.add("What is the different in valuation in a merger of equals versus an acquisition of a smaller firm by a larger firm?");

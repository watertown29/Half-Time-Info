...
public class OceanSprayActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22Ocean%20Spray%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("Suppose we have a goal of getting Craisins into every school cafeteria in the US. What is the size of the opportunity?");
        questions.add("Tell me about a brand you think is marketed well.");
        questions.add("Pact Water as a brand had not been doing well. What do you want to know in order to fix it?");
        questions.add("Tell me about a key trend in food & beverages that you find interesting.");
        questions.add("Why Ocean Spray?");
        questions.add("Why consumer packaged goods?");
        questions.add("Describe your favorite boss and what you liked about them.");

...
public class SCJActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22S.C.%20Johnson%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("Would you like to live in Racine, WI?");
        questions.add("Evaluate the packaging of Kleenex and Purell.");
        questions.add("What is your biggest hesitation about coming to SCJ");
        questions.add("Tell me about a situation that you had to take a risk.");
        questions.add("If you were CEO of your old company, what changes would you suggest that they make? Why?");
        questions.add("Why consumer packaged goods?");
        questions.add("How do you feel your skills and strengths are in line with Brand Management, and what are some challenges that you foresee yourself having?");
        questions.add("Talk about the potential cannibalization of sales that your new product line might cause with regard to the previously existing product.");

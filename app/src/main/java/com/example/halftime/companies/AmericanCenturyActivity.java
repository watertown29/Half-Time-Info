...
public class AmericanCenturyActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22american%20century%20investments%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("What are the different ways that a company can use its cash?");
        questions.add("Why do you want to work for American Century?");
        questions.add("Why do you want to live in Kansas City?");
        questions.add("Explain how a company could grow earnings 20% year over year for several years in a row and have it's stock trade flat over that same period.");
        questions.add("What's your investment philosophy?");
        questions.add("Are you more of a growth or value-oriented investor?");
        questions.add("Compare a software and industrial machinery company. What are the main differences? What are similarities?");
        questions.add("How would you value an airline company?");
        questions.add("Tell me about an investment book you recently read.");

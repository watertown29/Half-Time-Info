...
public class MarsActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22Mars%20Candy%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("How would you grow the brand or category in the face of healthier living?");
        questions.add("What trends do you think are affecting our business?");
        questions.add("What is your favorite Mars brand and why?");
        questions.add("What are your 3 greatest strengths?");
        questions.add("Competitor comes out with a pretzel chocolate candy that competes with pretzel m&m and market share is declining. What do you do?");
        questions.add("Give us an example of a bad ad campaign you have seen recently and why was is bad?");
        questions.add("Evaluate this ad for me [Clorox disinfecting wipes print ad]");

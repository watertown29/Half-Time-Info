...
public class NestleActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22Nestlé%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("Tell me about a time you had a great deal of data before you but had to make a split second or quick decision?");
        questions.add("What attracts you to marketing?");
        questions.add("What are two trends you can identify in the food industry today?");
        questions.add("Why food?");
        questions.add("How do you stay on top of marketing and food industry trends?");
        questions.add("Why consumer packaged goods?");
        questions.add("Name an ad campaign you like and why.");
        questions.add("Tell me about your leadership style.");
        questions.add("Tell me about a time you had to deviate from an established procedure.");

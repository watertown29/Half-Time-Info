...
public class GeneralMillsActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22General%20Mills%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("What is a GMI product that is under leveraged?");
        questions.add("What is your favorite CPG product?");
        questions.add("What is an innovative CPG product?");
        questions.add("You can launch peanut butter cheerios or caramel cheerios. How do you decide which to launch, which would you choose, and why?");
        questions.add("Tell me about a recent campaign that you've liked.");
        questions.add("Name 3 trends that is likely to have a big impact on the CPG industry.");
        questions.add("Tell me about a time you led a team.");
        questions.add("Why Minnesota?");
        questions.add("Why Food?");

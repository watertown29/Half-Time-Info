...
public class MattelActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22Mattel%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("Why Mattel? Why Marketing?");
        questions.add("What was your favorite toy when you were younger??");
        questions.add("Tell me about a time you failed.");
        questions.add("Who have you met at our company?");
        questions.add("What are insights that you look for in research?");
        questions.add("What is your analysis of our competitors?");
        questions.add("What interests you most about this position?");
        questions.add("Why are you interested in Fisher-Price?");

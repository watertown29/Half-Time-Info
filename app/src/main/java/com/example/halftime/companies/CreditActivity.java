...
public class CreditActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22credit%20suisse%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("Can you provide me a time you had to build relationships quickly?");
        questions.add("What qualities do you have that make you stand out from other candidates?");
        questions.add("Are you following the markets? Do you have a stock pitch?");
        questions.add("Walk me through an LBO.");
        questions.add("Can you meet your IRR target if your exit multiple decreases?");
        questions.add("You have a flood that damages $20mm in inventory. Walk me through the impact on each financial statement.");
        questions.add("Tell me about a time where you got very deep in the numbers for a project at work or at school.");
        questions.add("If you're buying a company would you prefer the target company have a DTA or DTL?");

...
public class CitibankActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22Citibank%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("How would you improve Citi Cards?");
        questions.add("What is something you would improve about Citi or Citi's customer service?");
        questions.add("Walk me through your resume, highlighting any experiences that would be beneficial to working at Citi.");
        questions.add("Why financial services? What trends are you seeing now that are impacting the industry?");
        questions.add("Have you spoken with anyone at Citi?");
        questions.add("Tell me about a time you faced an ethical dilemma.");
        questions.add("What would be the perfect role at Citi Consumer Banking if you could pick any role? [e.g. product manager, growth strategy, regulatory etc.]");
        questions.add("Tell me about a time you had to persuade your team to see something your way/get buy-in on a project.");
        questions.add("What do you bring to Citi?");

...
public class BAMLActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22bank%20of%20america%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("What investments would you advise your grandmother to invest in?");
        questions.add("Can you tell me how the three financial statements interact?");
        questions.add("How do you calculate WACC?");
        questions.add("Describe the loan/bond issuing process and why each is issued over the other?");
        questions.add("Why do you want to work at Bank of America Merrill Lynch?");
        questions.add("What groups are you interested in?");
        questions.add("Tell me about recent BAML deals that interest you.");
        questions.add("Who have you met at the bank?");
        questions.add("Where do you think the interest rates are headed and why?");

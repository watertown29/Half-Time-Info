...
public class BarclaysActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22barclays%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("What is your outlook on interest rates? And who could benefit?");
        questions.add("Walk me from Net Income to Free Cash Flow.");
        questions.add("Why Barclays?");
        questions.add("What is the title of your autobiography?");
        questions.add("What are the G10 currencies?");
        questions.add("Briefly summarize the state of the financial industry");
        questions.add("What other firms are you talking to?");
        questions.add("A company you are looking at missed consensus EPS. You only have thirty minutes to issue a note. Where do you look first?");
        questions.add("Tell me about a recent deal/news item that you've been following?");

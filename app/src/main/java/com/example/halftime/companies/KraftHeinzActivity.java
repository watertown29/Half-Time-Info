...
public class KraftHeinzActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22Kraft%20Heinz%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("Estimate the number of gallons of water used in Chicago today.");
        questions.add("A new jello pudding is losing market share with health conscious women. What would you do?");
        questions.add("Why brand management?");
        questions.add("Tell me a time you were creative.");
        questions.add("I am an outgoing brand manager on a product you will now join. Ask me 5 questions.");
        questions.add("What is it like to shop at Target?");
        questions.add("Kraft is launching a new product, \"walnut cereal.\" The walnuts come from Brazil, but the plant just went on strike. What would you do?");

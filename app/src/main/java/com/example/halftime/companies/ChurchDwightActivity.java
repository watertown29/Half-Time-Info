...
public class ChurchDwightActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22Church%20Dwight%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("What is your favorite Church & Dwight product and why?");
        questions.add("Why New Jersey?");
        questions.add("Why Church & Dwight?");
        questions.add("What do you think is a current challenge for Brand Managers?");
        questions.add("Tell me about a time you used data to persuade someone who didn't initially agree with you?");
        questions.add("Tell me about one of our brands and what you think our brand equity is?");
        questions.add("Tell me about one of our recent ad campaigns that you have enjoyed.");
        questions.add("Why are you interested in CPG?");
        questions.add("What do you consider to be your greatest strengths?");

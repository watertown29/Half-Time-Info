...
public class UnileverActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22Unilever%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("Tell me about an ad campaign you liked.");
        questions.add("Tell me about a time you persuaded a group.");
        questions.add("If you were to recommend an extension to this favorite brand, what would it be and why?");
        questions.add("Tell me about a particularly innovative product? What do you think the core consumer is? What do you think the insight is?");
        questions.add("Why Unilever?");
        questions.add("Why consumer packaged goods?");
        questions.add("Who was the target segment at your prior company?");
        questions.add("Favorite Unilever product and why?");
        questions.add("Give an example of a product that you would not like to market.");

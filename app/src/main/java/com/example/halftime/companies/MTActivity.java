...
public class MTActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22m%26t%20bank%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("What about M&T Bank made you want to apply for this position?");
        questions.add("Can you see yourself living in Buffalo?");
        questions.add("What questions do you have about M&T?");
        questions.add("How do you prioritize multiple tasks when under time pressure?");
        questions.add("Tell me about a time when you made a decision with incomplete information.");
        questions.add("How does M&T Bank make money?");
        questions.add("What are two important factors that are influencing the American economy right now?");
        questions.add("What job in your life did you have that you liked the least and why?");

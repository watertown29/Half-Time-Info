...
public class DBActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {

    private static final String AMERICAN_EXPRESS_REQUEST_URL = "https://newsapi.org/v2/everything?q=%22deutsche%20bank%22&language=en&sortBy=relevancy&apiKey=992b068daeb146349573a7d0fae39deb&pageSize=6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add("Why Investment Banking?");
        questions.add("Who have you met at the bank?");
        questions.add("How is DB different from other firms?");
        questions.add("What questions do you have for us? What would you like to know about DB?");
        questions.add("Why would you use multiples to value a company? Which multiples would you use?");
        questions.add("What are the different methods of valuation?");
        questions.add("Talk to me about a deal you've been following.");
        questions.add("Even though debt is cheaper than equity, why wouldn't a company want to be financed by 100% debt?");
        questions.add("What were your key deliverables in your last job?");
